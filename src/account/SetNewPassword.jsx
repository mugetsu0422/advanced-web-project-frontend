    ...
    <>
      ...
      >
        <div className={styles['form-div']}>
          ...
          <BootstrapForm.Group controlId="newPassword" className={styles['my-input-group']}>
          ...
          <BootstrapForm.Group controlId="confirmPassword" className={styles['my-input-group']}>
            <BootstrapForm.Label></BootstrapForm.Label>
            <BootstrapForm.Control
              className={styles['my-input']}
              required
...
function SetNewPassword() {
  ...
  function handleFormSubmit(event) {
    ...
    if (form.checkValidity() === false || inputs.newPassword !== inputs.confirmPassword) {
      return;
    }
